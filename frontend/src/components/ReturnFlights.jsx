...
function ReturnFlights(){   // for USER & GUEST
   ...
   if (location.state!=null){ 
       flag=true;          //checking if user searched for a flight & selected a departure flight & variables were passed, , no url jumping
